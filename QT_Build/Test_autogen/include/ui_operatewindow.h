...
public:
    ...
    QPushButton *btnQueryMarkManage;
...
"QTabBar::tab:selected{color:#000000;border-bottom:6px solid rgb(0,0,0);background-color:#FFFFFF;}"));
        ...
        btnQueryMarkManage = new QPushButton(tabMarkManage);
        btnQueryMarkManage->setObjectName(QString::fromUtf8("btnQueryMarkManage"));
        btnQueryMarkManage->setGeometry(QRect(970, 400, 211, 41));
        QFont font2;
        font2.setPointSize(15);
        btnQueryMarkManage->setFont(font2);
    ...
    void retranslateUi(QMainWindow *OperateWindow)
    {
        ...
        btnQueryMarkManage->setText(QApplication::translate("OperateWindow", "\346\237\245                \350\257\242", nullptr));
